...
import { ThreadMessageLike } from "./thread-message-like";
import {
  MessageRuntime,
  MessageRuntimeImpl,
  MessageState,
...
import { symbolInnerMessage } from "./external-store-message";
import { ModelContext } from "../model-context";
import { ChatModelRunOptions, ChatModelRunResult } from "./chat-model-adapter";
