...
<Callout type="info" title="Need help?">
  ...
  configuration, and manual setup steps, see the main [Getting
  Started guide](/docs).
</Callout>
...
Your assistant-ui frontend now communicates with a Mastra agent running in your Next.js backend API route. To explore advanced Mastra features (memory, tools, workflows), refer to the [official Mastra documentation](https://mastra.ai/docs).
