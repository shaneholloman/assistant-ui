...
The content of the message. This renders a separate component for each message part of the message.
      ...
      children: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: "object",
              description:
                "The component to render for each tool call message part.",
              children: [
                {
                  parameters: [
                    {
                      ...
                      description:
                        "The components to render for each tool call message part.",
                    },
                    {
                      name: "Fallback",
                      type: "ToolCallMessagePartComponent",
                      description:
                        "The fallback component to render for tool call message parts.",
                    },
                  ],
                },
              ],
            },
            {
              ...
              description:
                "Component for rendering grouped consecutive tool calls. When provided, consecutive tool-call message parts will be automatically grouped and wrapped with this component.",
              children: [
                {
                  type: "ToolGroupProps",
                  parameters: [
