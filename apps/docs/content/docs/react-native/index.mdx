...
```
EXPO_PUBLIC_OPENAI_API_KEY="sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
```
...
```sh
npx expo install @assistant-ui/react-native @assistant-ui/react-ai-sdk @assistant-ui/react
```
...
Wrap your app with `AssistantProvider` and build your chat UI:
