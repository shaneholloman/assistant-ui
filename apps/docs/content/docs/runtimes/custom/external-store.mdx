...
### External Bridge (Partial Compatibility)

If you already use a custom bridge runtime, use a mapping with
`ExternalStoreRuntime` and treat compatibility as explicitly scoped.

- Bridge guide: [External Store Runtime](/docs/runtimes/custom/external-store)
