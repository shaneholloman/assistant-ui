...
<ComposerPrimitive.Unstable_TriggerPopoverRoot>
  <ComposerPrimitive.Root>
    ...
    {/* / slash command — removes the command text and runs a handler */}
    <ComposerPrimitive.Unstable_TriggerPopover
      triggerId="slash"
      char="/"
...
<ComposerPrimitive.Unstable_TriggerPopoverRoot>
  <ComposerPrimitive.Root>
    ...
    <ComposerPrimitive.Unstable_TriggerPopover triggerId="mention" char="@" adapter={mentionAdapter} onSelect={{ type: "insertDirective", formatter }}>
      ...
    </ComposerPrimitive.Unstable_TriggerPopover>
  </ComposerPrimitive.Root>
</ComposerPrimitive.Unstable_TriggerPopoverRoot>
...
Declares a trigger (by `triggerId`, `char`, `adapter`, `onSelect`) and renders the popover container. Only renders its DOM (and children) while the trigger is active in the composer input.
...
- `{ type: "action", handler }` — removes the trigger text from the composer and calls the handler (slash-command behavior)
