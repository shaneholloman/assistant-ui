    ...
    <SDKGuideRuntimeProvider>
      ...
      >
        ...
        <AssistantModalPrimitive.Content
          ...
          align="end"
          sideOffset={16}
          className="data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 z-50 flex h-[calc(100vh-6rem)] w-[420px] max-w-[calc(100vw-2rem)] flex-col overflow-clip rounded-xl border bg-background/50 text-popover-foreground shadow-lg outline-none backdrop-blur-sm data-[state=closed]:animate-out data-[state=open]:animate-in [&>.aui-thread-root]:bg-inherit"
        >
          <SDKGuideThread />
        </AssistantModalPrimitive.Content>
      </AssistantModalPrimitive.Root>
